...
sudo -E guix system -L ~/.dotfiles/.config/guix/systems reconfigure ~/.dotfiles/.config/guix/systems/faulobst.scm
...
=faulobst= is a ThinkPad X1 Carbon 3rd Gen that I use for daily work.

*.config/guix/systems/faulobst.scm:*

#+begin_src scheme :tangle .config/guix/systems/faulobst.scm
